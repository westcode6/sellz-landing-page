...
<section class="py-10 lg:py-24 px-8">
    <div class=" animate__animated animate__bounceInLeft text-center">
        <h2 class="text-2xl md:text-4xl font-semibold text-[#04082f]">Bring your Content and <br /> Community Together!</h2>
    </div>
    ...
    <div class="w-full flex items-center justify-center mt-2 md:mt-10">
        <button class="w-fit px-10 py-4 animate__animated animate__bounceInUp animate__delay-2s bg-[#FBBD23] text-white text-lg font-semibold rounded-sm">Get Started for Free</button>
    </div>
   </section>